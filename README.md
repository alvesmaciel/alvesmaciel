...
🎓 Formado em **Informática para Internet pelo SENAI**
💻 Desenvolvedor focado em **interfaces modernas, responsivas e funcionais**
🧠 Apaixonado por tecnologia, aprendizado contínuo e resolução de problemas
⚡ Experiência com **front-end + back-end básico + banco de dados**
...
✔️ Segurança da informação (básico)
...
Busco oportunidades como **Desenvolvedor Web**, com foco em evolução constante, participação em projetos reais e crescimento profissional.
